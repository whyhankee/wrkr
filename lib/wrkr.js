...
function Wrkr(options) {
  ...
  this.archiveMethod = options.archiveMethod;
  this.eventHandlers = {};
  ...
  if (!this.archiveMethod) {
    throw new Error('no archiveMethod passed');
  }
